    ...
    return (
        <footer className="footer p-10 bg-base-300 text-base-content">
            <div>
                ...
                <Link className="link link-hover">Photograph</Link>
                <Link className="link link-hover">Photo editing</Link>
                <Link className="link link-hover">Video</Link>
                <Link className="link link-hover">Digital service</Link>
            </div>
            <div>
